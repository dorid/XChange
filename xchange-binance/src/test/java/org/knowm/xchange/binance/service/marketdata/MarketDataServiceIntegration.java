...
public class MarketDataServiceIntegration {
  ...
  private BinanceKline getBinanceKline(CurrencyPair pair) throws IOException {
    BinanceMarketDataService service = (BinanceMarketDataService) marketService;
    BinanceKline binanceKline = service.lastKline(pair, KlineInterval.m1);
    return binanceKline;
  }
  ...
  public void testBTC() throws Exception {
    ...
    for (int i = 0; i < 1000; i++) {
      BinanceKline binanceKline = getBinanceKline(CurrencyPair.BTC_USDT);
